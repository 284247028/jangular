...
function angularizeAttrs(e, scope) {
    ...
    for (var attr in attrs) {
        ...
        if (!transforms[attrNormal]) { continue; }
...
function angularize(e, scope, isInRepeat) {
    ...
    //counters.angularizeAttrs = (new Date()).getTime() - startTime;
    ...
    if (e.children) {
        ...
        for (i = 0; i < len; i++) {
            ...
            //startTime = (new Date()).getTime();
            //counters['child' + i + '-atotal'] = 0;
            //counters['child' + i + '-inner'] = {};
            // counters['child' + i + '-inner']
            ...
            //if (totalTime > 0) {
            //    counters['child' + i + '-atotal'] = totalTime;
            //}
        }
