...
var Jeff = require('jeff-core'),
    savedFilters = {}, addClasses = null, removeClasses = null, ngRepeat = null, patternPrefix = /^(x\-|data\-)/g, patternDelimit = /[_:]/g, patternPluralize = /\{\}/g;
...
ngRepeat = function(e, model) {
    var repeats = e.ngRepeat.split(' track by ')[0].split('|')[0].split(' in '), reps = [];
...
/*
function makeTransformFromDirective(directiveName, directiveValue) {
    return makeDirective[type](directiveName, directiveValue);
}
*/
