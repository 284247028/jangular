...
function stringifyWithFunction(key, value) {
    //console.log('stringify ' + key + ' with value ' + value);
...
function angularize(e, currentModel) { // e is an already-built Jeff element w attributes, children, and text - and a tagName...
    ...
    for ( var prop in currentModel ) {
        var stringified = JSON.stringify(currentModel[prop], stringifyWithFunction);
