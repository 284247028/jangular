...
Jeff.angularize = function angularize(e, currentModel) { // e is an already-built Jeff element w attributes, children, and text - and a tagName...
    if ( !e ) {
        return e;
    }
...
ngRepeat = function(e, model) {
    var repeats = e.ngRepeat.split('|')[0].split(' in '), reps = [];
